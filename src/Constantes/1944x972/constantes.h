...
#define N                    1944 // Nombre de Variables
#define K                    972 // Nombre de Checks   
#define ONE_COUNT            6966 // Nombre de Messages 
#define nb_MAX_un_dans_ligne 8
#define nb_FU                24
#define optim_chrgt          0
#define nb_var_tot_par_ram   81
#define TAILLE_RAM_PNODE     12360 // = taille ram interleaver
#define TAILLE_VALID_RAM     1944
#define NB_CYCLE_EXEC        72
