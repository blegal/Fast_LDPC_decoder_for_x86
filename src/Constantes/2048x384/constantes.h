...
#define N                    2048 // Nombre de Variables
#define K                    384 // Nombre de Checks   
#define ONE_COUNT            12288 // Nombre de Messages 
#define nb_MAX_un_dans_ligne 32
#define nb_FU                24
#define optim_chrgt          0
#define nb_var_tot_par_ram   85
#define TAILLE_RAM_PNODE     26112 // = taille ram interleaver
#define TAILLE_VALID_RAM     2064
#define NB_CYCLE_EXEC        34
