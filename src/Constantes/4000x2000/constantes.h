...
#define N                    4000 // Nombre de Variables
#define K                    2000 // Nombre de Checks   
#define ONE_COUNT            12000 // Nombre de Messages 
#define nb_MAX_un_dans_ligne 6
#define nb_FU                79
#define optim_chrgt          0
#define nb_var_tot_par_ram   50
#define TAILLE_RAM_PNODE     20382 // = taille ram interleaver
#define TAILLE_VALID_RAM     4029
#define NB_CYCLE_EXEC        43
