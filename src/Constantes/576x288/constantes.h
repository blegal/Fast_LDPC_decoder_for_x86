...
#define N                    576 // Nombre de Variables
#define K                    288 // Nombre de Checks   
#define ONE_COUNT            1824 // Nombre de Messages 
#define nb_MAX_un_dans_ligne 7
#define nb_FU                23
#define optim_chrgt          0
#define nb_var_tot_par_ram   25
#define TAILLE_RAM_PNODE     6417 // = taille ram interleaver
#define TAILLE_VALID_RAM     598
