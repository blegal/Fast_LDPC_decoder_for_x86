...
#define N                    1408 // Nombre de Variables
#define K                    384 // Nombre de Checks   
#define ONE_COUNT            4992 // Nombre de Messages 
#define nb_MAX_un_dans_ligne 18
#define nb_FU                24
#define optim_chrgt          0
#define nb_var_tot_par_ram   58
#define TAILLE_RAM_PNODE     17568 // = taille ram interleaver
#define TAILLE_VALID_RAM     1416
#define NB_CYCLE_EXEC        54
