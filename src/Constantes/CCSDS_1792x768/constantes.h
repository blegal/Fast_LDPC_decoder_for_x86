...
#define N                    1792 // Nombre de Variables
#define K                    768 // Nombre de Checks   
#define ONE_COUNT            5888 // Nombre de Messages 
#define nb_MAX_un_dans_ligne 10
#define nb_FU                24
#define optim_chrgt          0
#define nb_var_tot_par_ram   74
#define TAILLE_RAM_PNODE     12216 // = taille ram interleaver
#define TAILLE_VALID_RAM     1800
#define NB_CYCLE_EXEC        60
