...
#define N                    22528 // Nombre de Variables
#define K                    6144 // Nombre de Checks   
#define ONE_COUNT            79872 // Nombre de Messages 
#define nb_MAX_un_dans_ligne 18
#define nb_FU                24
#define optim_chrgt          0
#define nb_var_tot_par_ram   938
#define TAILLE_RAM_PNODE     96480 // = taille ram interleaver
#define TAILLE_VALID_RAM     22536
#define NB_CYCLE_EXEC        295
