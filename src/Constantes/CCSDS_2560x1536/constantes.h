...
#define N                    2560 // Nombre de Variables
#define K                    1536 // Nombre de Checks   
#define ONE_COUNT            7680 // Nombre de Messages 
#define nb_MAX_un_dans_ligne 6
#define nb_FU                24
#define optim_chrgt          0
#define nb_var_tot_par_ram   106
#define TAILLE_RAM_PNODE     8928 // = taille ram interleaver
#define TAILLE_VALID_RAM     2568
#define NB_CYCLE_EXEC        73
