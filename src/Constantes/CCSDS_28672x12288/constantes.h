...
#define N                    28672 // Nombre de Variables
#define K                    12288 // Nombre de Checks   
#define ONE_COUNT            94208 // Nombre de Messages 
#define nb_MAX_un_dans_ligne 10
#define nb_FU                24
#define optim_chrgt          0
#define nb_var_tot_par_ram   1194
#define TAILLE_RAM_PNODE     96312 // = taille ram interleaver
#define TAILLE_VALID_RAM     28680
#define NB_CYCLE_EXEC        521
