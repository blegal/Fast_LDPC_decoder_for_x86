...
#define N                    7168 // Nombre de Variables
#define K                    3072 // Nombre de Checks   
#define ONE_COUNT            23552 // Nombre de Messages 
#define nb_MAX_un_dans_ligne 10
#define nb_FU                24
#define optim_chrgt          0
#define nb_var_tot_par_ram   298
#define TAILLE_RAM_PNODE     26376 // = taille ram interleaver
#define TAILLE_VALID_RAM     7176
#define NB_CYCLE_EXEC        140
