...
#define N                    8176 // Nombre de Variables
#define K                    1022 // Nombre de Checks   
#define ONE_COUNT            32704 // Nombre de Messages 
#define nb_MAX_un_dans_ligne 32
#define nb_FU                511
#define optim_chrgt          0
#define nb_var_tot_par_ram   16
#define TAILLE_RAM_PNODE     457856 // = taille ram interleaver
#define TAILLE_VALID_RAM     8176
#define NB_CYCLE_EXEC        28
