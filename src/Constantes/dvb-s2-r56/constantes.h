...
#define K                    10800 // Nombre de Checks   
#define ONE_COUNT            237599 // Nombre de Messages 
#define nb_MAX_un_dans_ligne 22
#define nb_FU                127
#define optim_chrgt          0
#define nb_var_tot_par_ram   510
#define TAILLE_RAM_PNODE     360299 // = taille ram interleaver
#define TAILLE_VALID_RAM     64897
#define NB_CYCLE_EXEC        129
